...
public class Mark {
    ...
    public double getGpaNumeric() {
        ...
        if (totalMark >= 90) return 3.67;
        if (totalMark >= 85) return 3.33;
        if (totalMark >= 80) return 3.0;
        if (totalMark >= 75) return 2.67;
        if (totalMark >= 70) return 2.33;
        if (totalMark >= 65) return 2.0;
        if (totalMark >= 60) return 1.67;
        if (totalMark >= 55) return 1.33;
        if (totalMark >= 50) return 1.0;
        return 0.0;
    }
